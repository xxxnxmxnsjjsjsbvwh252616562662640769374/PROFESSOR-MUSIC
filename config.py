...
BOT_USERNAME = getenv("BOT_USERNAME", "@AdvancedMusic_Bot")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME", "Rɪsᴇ Assɪsᴛᴀɴᴛ")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME", "RisexAssistant001")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/twinkee7/PROFESSOR-MUSIC",
)
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://telegra.ph/file/b64a1fa450c5842fe5b47.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://telegra.ph/file/70a9de40d206782967c72.jpg"
)
